/** WE ARE USING A "FUNCTION" HERE TO CREATE / GENERATE MULTIPLY OBJECT  */


function Cart(localStorageKey) {
   // INSIDE THIS FUNCTION, WE ARE CREATING "cart objects" SO  WE WILL BE MOVING THE "cart" OBJECT ITO THE FUNCTION
  ...
  // WE ARE USING "return cart" SO WE CAN USE THESE "cart" OUTSIDE OF THE FUNCTION.
  return cart;
}
...
/** TO CONVERT THE (PROCEDURAL PROGRAMMING INTO OBJECT-ORIENTED PROGRAMMING), WE ARE GOING TO GROUP ALL THE "DATA" AND "FUNCTIONs" TOGETHER INTO AN OBJECT */
