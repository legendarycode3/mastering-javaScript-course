...
➡️ **FUNCTIONS** <br/>
	...
	✔️ Function Expression: A function expression in JavaScript defines a function as part of an expression, most commonly by assigning it to a variable. The function can be anonymous Functions can also be created by a function expression. Such functioncan be anonymous; It dies not have to have a name.  <br/>
