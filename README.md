...
oriented, functional, and event-driven styles.  </br>
...
➡️ **FUNCTIONS** <br/>
	...
	✔️ Function Expression: A function expression in JavaScript defines a function as part of an expression, most commonly by assigning it to a variable. The function can be anonymous (without a name) or named, and it is executed when the code flow reaches the assignment.  </br> 
	Functions can also be created by a function expression. Such functioncan be anonymous; It dies not have to have a name.  <br/>
	...
	✔️ Why do we use Function ? <br/>
	 Functions are a fundamental building block in JavaScript and are used for several key reasons that improve the overall quality and efficiency of the codebase. </br>
	  Key Reasons:: </br>
		...
		8. Flexibility (Input/Output): Functions can accept arguments (inputs) and return values (outputs), making them highly flexible for data manipulation.  </br>
...
   		 console.log(y); </br>
 ...
 E.G. </br>
	...
	NOTE: That an object is another type of value. </br>
	...
	 Object are reference means that, variables storing objects hold a reference to the object's location in memory, not the object's actual value itself.
	 ...
	 When you are comparing two variables that contains objects , you are actually comparing the references not the values inside. </br>
...
➡️ **TESTING** <br/>
	...
	over the DevTools Protocol, typically for headless browser automation. </br>
...
➡️ **BACK END,  CALL BACKS, PROMISES, AND ASYNC** <br/>
	...
	3. Integration: Connecting external services (e.g., email services, payment gateways) using APIs. </br>
	...
	These codes, like the common 404 Not Found or 200 OK, are vital for debugging, ensuring smooth user experiences, and helping search engines
	understand web content.  </br>
	...
	This is possible because functions in JavaScript are "first-class citizens,"  meaning they can be treated like variables and passed around as values. </br>
	...
	Promise: Is  fundamental concept for handling “asynchronous operation” in javascript. <br/>
		...
		continue running without being "blocked" while the asynchronous task (such as
		a data request, file I/O, or an API call) is in progress. </br>
...
3.) Async / Await:  A better way to handle “asynchronous code” . </br>
	...
	a cleaner, more readable, synchronous-like syntax for handling asynchronous
	operations, which are built on top of Promises. </br>
...
Error handling in JavaScript is primarily managed using the try...catch...finally 
mechanisms include the throw statement for custom errors, handling errors in
statement to gracefully manage runtime errors and prevent application crashes. </br>
Other asynchronous code with .catch() or try...catch in async functions, and global error handlers. </br>
